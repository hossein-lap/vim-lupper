...
let s:dark_orange     = { "gui": "#ff6600", "cterm": "167"  }
let s:light_orange    = { "gui": "#ffaa00", "cterm": "167"  }
let s:dark_blue       = { "gui": "#005Fb7", "cterm": "18"   }
let s:light_blue      = { "gui": "#008EC4", "cterm": "32"   }
let s:lighter_blue    = { "gui": "#20BBFC", "cterm": "12"   }
let s:lightest_blue   = { "gui": "#b6d6fd", "cterm": "153"  }
...
let s:active = s:blue
if &background == "dark"
	let s:dark_active = s:dark_blue
	let s:light_active = s:lighter_blue
	let s:visual = s:light_active
else
	let s:dark_active = s:lighter_blue
	let s:light_active = s:dark_blue
...
call s:h("Directory",     {"fg": s:dark_active})
call s:h("ErrorMsg",      {"fg": s:red})
call s:h("IncSearch",     {"bg": s:light_active, "fg": s:light_black})
call s:h("Search",        {"bg": s:lightest_blue, "fg": s:light_black})
...
call s:h("DiffText",      {"fg": s:dark_active})
...
call s:h("PmenuSel",      {"fg": s:black, "bg": s:active})
call s:h("PmenuSbar",     {"fg": s:norm, "bg": s:bg_subtle})
call s:h("PmenuThumb",    {"fg": s:norm, "bg": s:bg_subtle})
call s:h("TabLine",       {"fg": s:norm, "bg": s:bg_very_subtle})
call s:h("TabLineSel",    {"fg": s:subtle_black, "bg": s:active, "gui": s:thebold, "cterm": s:thebold})
